...
- **Flexible PK Strategies** — Autoincrement, integer (MAX+1 with retry), UUID v4, or bring your own
...
// Repository generates UUID v4
$repo->insert('users', 'id', $values, PkStrategy::STRING);
